...
public class ProfileActivity extends AppCompatActivity {
    ...
    public void find(View view) {
        ...
        String qb = "SELECT * FROM COURSEWORK WHERE regno = '" + reg.toUpperCase() + "'";
        ...
        Cursor cursor1 = handler.execQuery(qb);
        ...
        if (cursor1 == null || cursor1.getCount() == 0) {
            ...
            if (cursor == null || cursor.getCount() == 0) {
                ...
                String b = "SELECT * FROM COURSEWORK WHERE regno = '" + reg.toUpperCase() + "'";
                Cursor cursory = handler.execQuery(b);
                if (cursory == null || cursory.getCount() == 0) {
                    Toast.makeText(getBaseContext(), "No Coursework Marks Available", Toast.LENGTH_LONG).show();
                }else{
                    cursory.moveToFirst();
                    while (!cursory.isAfterLast()){
                        coursework.add(cursory.getInt(0));
                    }
